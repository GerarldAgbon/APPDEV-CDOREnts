    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('For Rent', 'For Rent'), ('For Sale', 'For Sale')], default='For Rent', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('Condo', 'Condo'), ('Room', 'Room'), ('Pad', 'Pad')], default='Room', max_length=50)),
