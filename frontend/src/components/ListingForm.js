...
const ListingForm = ( props ) => {
    ...
    const { sale_type, price, bedrooms, home_type, bathrooms, days_listed, has_photos, open_house, keywords } = formData;
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`http://localhost:8000/api/listings/search`, { sale_type, price, bedrooms, home_type, bathrooms, days_listed, has_photos, open_house, keywords })
        .then(res => {
            setLoading(false);
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        ...
                        <select className='listingform__select' name='price' onChange={e => onChange(e)} value={price}>
                            <option>Php 0+</option>
                            <option>Php 500+</option>
                            <option>Php 800+</option>
                            <option>Php 1200+</option>
                            <option>Php 1500+</option>
                            <option>Php 2000+</option>
                            <option>Php 2500+</option>
                            <option>Any</option>
                        </select>
                    </div>
                    <div className='listingform__section'>
